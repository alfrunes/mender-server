...
type Config struct {
	AuthVerifyMiddlewares []gin.HandlerFunc
}

type Option func(c *Config)

func ConfigAuthVerifyMiddleware(authMiddleware gin.HandlerFunc) Option {
	return func(c *Config) {
		c.AuthVerifyMiddlewares = append(c.AuthVerifyMiddlewares, authMiddleware)
	}
}
